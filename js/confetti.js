// found here --> http://jsfiddle.net/hcxabsgh/21/
...
function confetti() {
    ...
    this.InitializeConfetti = function() {
        particles = [];
    ...
    this.DeactivateConfetti = function() {
    ...
    this.RestartConfetti = function() {
        ...
        reactivationTimerHandler = setTimeout(function () {
            confettiActive = true;
            animationComplete = false;
            _this_.InitializeConfetti();
            _this_.StartConfetti();
        }, 100);
